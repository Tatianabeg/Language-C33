...
def get_number(number: int, mod: int = 10) -> str:
    """
    Функция на вход получает целое число, систему исчисления и возвращает его  строковое представление
...
def parser_func():
    parser = argparse.ArgumentParser(description='Принимаем аргументы из строки')
