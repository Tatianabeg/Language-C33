...
print("4. доля сдавших студентов от общего числа поступивших",pt)
...
#c
# вероятность, что не выйдет ни одна деталь
pn=q1*q2*q3
p=1-pn
print("5.в Вероятность выхода хотя бы 1й детали",p)
