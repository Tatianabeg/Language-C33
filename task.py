...
from math import pipi

d =  int(input("Ввод числа для заданной точности числа Пи:\n"))
...
# Задача : Задайте последовательность чисел. 
# Напишите программу, которая выведет список неповторяющихся элементов исходной последовательности.

lst = list(map(int, input("Ввод числа через пробел:\n").split()))
